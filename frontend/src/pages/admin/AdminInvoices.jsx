...
import { Download, ExternalLink, Search, Filter, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        { header: 'Due Date', cell: (row) => row.due_date },
        {
            ...
            cell: (row) => (
                <div className="flex space-x-3">
                    ...
                    {row.status !== 'PAID' && user.role === 'Admin' && (
                        <button onClick={() => navigate(`/customer/payment/${row.id}`)} className="text-emerald-600 hover:text-emerald-700 transition" title="Simulate Payment">
